    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">{posts.length} artykułów</p>
        </div>
        <Button asChild>
      ...
      {posts.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-slate-300 py-16 text-center">
          <p className="text-slate-500">Brak artykułów. Dodaj pierwszy!</p>
        </div>
      ) : (
          ...
          <table className="w-full text-sm">
            <thead className="border-b border-slate-200 bg-slate-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left font-semibold text-slate-700">Data</th>
