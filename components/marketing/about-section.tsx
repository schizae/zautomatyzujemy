...
export function AboutSection() {
  return <section id="o-nas" className="mx-auto max-w-[1600px] scroll-mt-24 px-6 pb-8 pt-20 md:px-8">
    <FadeInUp>
      <p className="mb-6 text-xs uppercase tracking-[0.2em] text-[#686862]">04 / Ludzie i wiedza</p>
      <h2 className="max-w-6xl font-body text-5xl font-extrabold leading-[1.05] tracking-[-0.055em] xl:text-8xl">Technologia ma sens,<br />gdy pomaga <span className="font-editorial font-normal italic">ludziom.</span></h2>
